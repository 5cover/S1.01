...
/* Prototype des fonctions de vérification de possibilité de placement */
...
/* Prototypes des procédures d'affichage */
...
/* Fonctions de vérification de possibilité de placement */
